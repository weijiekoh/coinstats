...
var CoinStatsDb = function () {
  ...
  _createClass(CoinStatsDb, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return this.Coin.sync();

              case 4:
                _context.next = 6;
                return this.PriceHistory.sync();
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt('return', this.Coin.findAll({
    ...
    key: 'updateCoins',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(coins) {
        var _this = this;
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                return this.sequelize.transaction(function () {
                  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(transaction) {
                        ...
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            ...
                            return Promise.all(coins.map(function () {
                              var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(coin) {
                                var lastUpdatedDate;
                                  ...
                                  while (1) {
                                    switch (_context3.prev = _context3.next) {
                                      ...
                                      case 8:
                                        ...
                                        console.error(_context3.t0, 'Could not add to price history');
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 8:
                ...
                console.error(_context6.t0, 'Could not delete old price data');
    ...
    value: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(ids) {
        var coins;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 3:
                ...
                return _context7.abrupt('return', coins.map(function (coin) {
              ...
              case 7:
                ...
                console.log(_context7.t0, 'Could not get coin data given these CMC IDs:', ids);
    ...
    key: 'getCoin',
    value: function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(cmcId) {
        var coin;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 3:
                ...
                // });
                delete coin.dataValues.id;
                return _context8.abrupt('return', coin.dataValues);

              case 8:
                _context8.prev = 8;
                _context8.t0 = _context8['catch'](0);

                console.error('Could not get coin data:', _context8.t0);
    ...
    key: 'getCoins',
    value: function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(start, limit, sortParam, direction, minPriceUsd, minVolUsd) {
        var where, coins, c;
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 7:
                coins = _context9.sent;
                c = coins.rows.map(function (c) {
                  delete c.dataValues.id;
                  return c.dataValues;
                });
                return _context9.abrupt('return', { coins: c, totalCoins: coins.count });

              case 12:
                _context9.prev = 12;
                _context9.t0 = _context9['catch'](0);

                console.error(_context9.t0, 'Could not get list of coins');
                throw new UnableFetchCoinsException();
    ...
    key: 'getPriceHistory',
    value: function () {
      var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(cmcId, earliestTimestamp) {
        ...
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 17:
                _context10.prev = 17;
                return _context10.abrupt('return', this.PriceHistory.findAll({
                  where: where,
                  order: [['datetime', 'ASC']]
              ...
              case 21:
                ...
                console.error(_context10.t2, 'Could not fetch price history');
                throw new UnableFetchCoinException();
